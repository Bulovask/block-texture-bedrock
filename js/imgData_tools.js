const pixelManipulationScreenElem = document.createElement("canvas");
pixelManipulationScreenElem.width = 1;
pixelManipulationScreenElem.height = 1;
const pixelManipulationScreenCtx = pixelManipulationScreenElem.getContext("2d", {willReadFrequently: true});

document.body.append(pixelManipulationScreenElem)
pixelManipulationScreenElem.style = "width: 10%; position: fixed"
...
class ImgData {
    ...
    static drawPixel(imgData, color, x, y) {
        ...
        if(pixel) {
            ...
            const ctx = pixelManipulationScreenCtx;
            ...
            console.log(newColor, normalizedColor)
        }
    }
}
